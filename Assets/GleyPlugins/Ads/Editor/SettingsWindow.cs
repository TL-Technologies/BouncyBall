namespace GleyMobileAds
{
    ...
    public class SettingsWindow : EditorWindow
    {
        ...
        {
            SettingsWindow window = (SettingsWindow)GetWindow(typeof(SettingsWindow), true, "Mobile Ads Settings Window - v.1.5.7");
        ...
        private void UpdateAdvertiserSettings()
        {
            ...
            {
                AdvertiserSettings advertiser = new AdvertiserSettings(SupportedAdvertisers.Vungle, "https://publisher.vungle.com/sdk/plugins/unity", "USE_VUNGLE");
                advertiser.platformSettings = new List<PlatformSettings>
                {
            ...
            {
                AdvertiserSettings advertiser = new AdvertiserSettings(SupportedAdvertisers.Facebook, "https://developers.facebook.com/docs/audience-network/download#unity", "USE_FACEBOOKADS");
                advertiser.platformSettings = new List<PlatformSettings>
                {
